...
public class MinioTest {
    ...
    MinioClient minioClient =
            MinioClient.builder()
                    .endpoint("http://192.168.163.129:9000")
    ...
    public void test_upload() throws Exception {
        ...
        UploadObjectArgs uploadObjectArgs = UploadObjectArgs.builder()
                .bucket("testbucket")//桶
                .filename("D:\\code\\testSource\\videos\\test1.mp4") //指定本地文件路径
//                .object("1.mp4")//对象名 在桶下存储该文件
    ...
    public void test_getFile() throws Exception {
        ...
        //指定输出流
        FileOutputStream outputStream = new FileOutputStream("D:\\code\\testSource\\videos\\1a.mp4");
        IOUtils.copy(inputStream,outputStream);

        //校验文件的完整性对文件的内容进行md5
        FilterInputStream fileInputStream1 = minioClient.getObject(getObjectArgs);
        String source_md5 = DigestUtils.md5Hex(fileInputStream1);
        FileInputStream fileInputStream = new FileInputStream("D:\\code\\testSource\\videos\\1a.mp4");
