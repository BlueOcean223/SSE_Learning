...
public class Mp4VideoUtil extends VideoUtil {
    ...
    // 检查文件路径
    private void check_video_path(){
        File videoFile = new File(video_path);
        if(!videoFile.exists()){
            System.out.println("原视频文件路径不存在");
            throw new RuntimeException("原视频文件路径不存在");
        }
    }
    //清除已生成的mp4
...
//        Process p = builder.start();
        ...
        //ffmpeg的路径
        String ffmpeg_path = "D:\\code\\testSource\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\code\\testSource\\videos\\test1.avi";
        //转换后mp4文件的名称
        String mp4_name = "tttt111.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\code\\testSource\\videos\\tttt111.mp4";
        //创建工具类对象
